...
class _MyHomePageState extends State<Home> {
  ...
  Future<Map<String, dynamic>> getUserData() async {
    final response = await http
        .get(Uri.parse('https://corona.lmao.ninja/v2/countries/indonesia'));
    return jsonDecode(response.body);
  }

  final String _url =
      'https://www.google.com/search?q=apa+itu+COVID-19&sxsrf=AOaemvLUCsam7PyShBu846Qc5ORxj2wdew%3A1635904457608&ei=yeuBYajTJMzl9QO6o6LQBw&oq=apa+itu+COVID-19&gs_lcp=_gGIAfoLkgEGMTEuNC4xmAEAoAEBsAEKwAEB&sclient=gws-wiz&ved=0ahUKEwjo29OAi_vzAhXMcn0KHbqRCHoQ4dUDCA0&uact=5';
  final String _url1 =
      'https://www.google.com/search?q=cara+penanganan+covid-19&sxsrf=AOaemvIu02-q5s3eRDADm6WX33f1rXsPmw%3A1635904468703&ei=1OuBYYiWKtPerQHZybuYBw&oq=cara&gs_lcp=Cgdnd3Mtd2l6EAEYADIECCMQJzIECCMQJzIECCMQJzIECAAQQzIECAAQQzIECAAQQzIECAAQQzIICAAQgAQQsQMyCAgAEIAEELEDMgUIABCABDoHCCMQ6gIQJzoHCAAQsQMQQzoKCAAQsQMQgwEQQzoFCAAQsQNKBAhBGABQ7_tSWOL_UmCAjFNoAXAAeACAAYUBiAGBA5IBAzIuMpgBAKABAbABCsABAQ&sclient=gws-wiz';
  @override
            ...
            children: <Widget>[
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    const Text(
                      'Situs ini memuat info seputar penyakit COVID-19 di Indonesia, '
                      'mulai dari data penyakit COVID-19 terkini, info vaksinasi, rujukan rumah sakit, '
                      'hingga forum untuk berdiskusi seputar penyakit COVID-19.',
                      ...
                      children: <Widget>[
                        Expanded(
                          ...
                          children: <Widget>[
                            ...
                            const Text(
                              'COVID-19 adalah penyakit yang disebabkan oleh virus corona atau severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2). COVID-19 dapat menyebabkan gangguan sistem pernapasan, mulai dari gejala yang ringan seperti flu, hingga infeksi paru-paru, seperti pneumonia.',
                              textAlign: TextAlign.justify,
                            )
                          ],
                        )),
              ...
              Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget>[
                    Text('Kasus Positif COVID-19 Hari Ini',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    const Text(
                                ...
                                if (snapshot.hasData) {
                                  return Column(
                                    children: [
                                      ...
                                      Text(
                                        (snapshot.data as Map)['todayCases']
                                            .toString(),
                                        style: TextStyle(color: Colors.white),
                                      ),
                                    ],
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ExpansionTile(
                      ...
                      children: [
                        Text(
                            '1. Riwayat perjalanan (jika ada, ke Tiongkok atau negara-negara yang sudah terjangkit COVID-19, seperti Singapura, Jepang, Korea Selatan, dan Italia).'),
                    ...
                    ExpansionTile(
                      ...
                      children: [
                        Text(
                            '1. Sampel spesimen akan diambil menggunakan alat berbentuk batang cotton bud namun lebih panjang, melalui hidung.'),
                        Text(
                            '2. Sampel tersebut akan dikirim ke laboratorium untuk dites PCR (Reaksi Berantai Polimerase). Pemerintah sudah menunjuk laboratorium di 10 kota yaitu Batam, Medan, Palembang, Makassar, Manado, Ambon, Jakarta, Bandung, Yogyakarta, Surabaya, dan Banjarmasin untuk melakukan tes ini.'),
                      ],
                    ),
                  ],
                ),
